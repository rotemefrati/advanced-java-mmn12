...
public class SavingsAccount extends BankAccount {
    // Default interest rate for the SavingsAccount.
    private static final double DEFAULT_INTEREST_RATE = 3;
    // Instance variable to store the interest rate for the account.
    private double interestRate;

    // Constructor to create a SavingsAccount with a default interest rate.
    public SavingsAccount(String accountNumber, String accountHolderName, String idNumber, double accountBalance) {
        super(accountNumber, accountHolderName, idNumber, accountBalance);
        this.interestRate = DEFAULT_INTEREST_RATE;
    }

    // Constructor to create a SavingsAccount with a custom interest rate.
    public SavingsAccount(String accountNumber, String accountHolderName, String idNumber, double accountBalance, double interestRate) {
        super(accountNumber, accountHolderName, idNumber, accountBalance);
